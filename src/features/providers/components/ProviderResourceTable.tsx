...
const ProviderResourceRow = memo(function ProviderResourceRow({
  resource,
  disableMutations,
  onView,
  onEdit,
...
export const ProviderResourceTable = memo(function ProviderResourceTable({
  resources,
  disableMutations,
  onView,
  onEdit,
